...
from soundalarm.streamalarm import StreamAlarm

Builder.load_file("./myclockpi/defaultstyle.kv")
...
class ClockControllerApp(App):
    ...
    def __init__(self):
        ...
        self.testalarm = StreamAlarm("http://mp3channels.webradio.rockantenne.de/soft-rock.aac")
